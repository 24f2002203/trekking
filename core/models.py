...
class Treks(db.Model):
    ...
    member_slots= db.Column(db.Integer(), nullable=False, default=10)
    available_member_slots= db.Column(db.Integer(), nullable=True, default=10)
    status = db.Column(db.Enum('Complete', 'Ongoing','pending','Started','Ongoing','Completed', 'open', 'closed', name='trek_status'), nullable=False, default='pending')
